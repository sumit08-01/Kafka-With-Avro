...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4307771459274436511L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"com.avroClasses\",\"fields\":[{\"name\":\"greeting\",\"type\":\"string\"}]}");
   ...
   */
  public static com.avroClasses.Greeting.Builder newBuilder() {
    return new com.avroClasses.Greeting.Builder();
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static com.avroClasses.Greeting.Builder newBuilder(com.avroClasses.Greeting.Builder other) {
    if (other == null) {
      return new com.avroClasses.Greeting.Builder();
    } else {
      return new com.avroClasses.Greeting.Builder(other);
    }
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static com.avroClasses.Greeting.Builder newBuilder(com.avroClasses.Greeting other) {
    if (other == null) {
      return new com.avroClasses.Greeting.Builder();
    } else {
      return new com.avroClasses.Greeting.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.avroClasses.Greeting.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.avroClasses.Greeting other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.greeting)) {
        this.greeting = data().deepCopy(fields()[0].schema(), other.greeting);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avroClasses.Greeting.Builder setGreeting(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avroClasses.Greeting.Builder clearGreeting() {
      greeting = null;
