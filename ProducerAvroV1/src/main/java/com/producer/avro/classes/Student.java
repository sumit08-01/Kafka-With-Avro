 ...
 */
package com.producer.avro.classes;
...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 75303564746226333L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"com.producer.avro.classes\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"studentName\",\"type\":\"string\",\"default\":\"sumit\"},{\"name\":\"age\",\"type\":\"int\"}]}");
   ...
   */
  public Student(java.lang.Integer id, java.lang.CharSequence studentName, java.lang.Integer age) {
    this.id = id;
   ...
   */
  public static com.producer.avro.classes.Student.Builder newBuilder() {
    return new com.producer.avro.classes.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.producer.avro.classes.Student.Builder newBuilder(com.producer.avro.classes.Student.Builder other) {
    if (other == null) {
      return new com.producer.avro.classes.Student.Builder();
    } else {
      return new com.producer.avro.classes.Student.Builder(other);
    }
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.producer.avro.classes.Student.Builder newBuilder(com.producer.avro.classes.Student other) {
    if (other == null) {
      return new com.producer.avro.classes.Student.Builder();
    } else {
      return new com.producer.avro.classes.Student.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.producer.avro.classes.Student.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.producer.avro.classes.Student other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.producer.avro.classes.Student.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.producer.avro.classes.Student.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.producer.avro.classes.Student.Builder setStudentName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.producer.avro.classes.Student.Builder clearStudentName() {
      studentName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.producer.avro.classes.Student.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.producer.avro.classes.Student.Builder clearAge() {
